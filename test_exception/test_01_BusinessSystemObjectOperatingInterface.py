...
class TestAPIService(object):
    ...
    def test_01_postapiservice(self):
        ...
        assert jobs["data"]["name"] == "New Service"

    def test_02_deleteservice_id(self):
    ...
    def test_03_modifyservice_id(self):
    ...
    def test_04_postapiservice(self):
        '''创建业务系统[post] api/service'''
        url = config.base_url + "/api/service"
        headers = {'Content-Type': 'application/json'}
        data = {"name0": self.name}
    ...
    def test_05_modifyservice_id(self):
        '''修改业务系统配置[post] /api/service/:service_id'''
        url = config.base_url + "/api/service/" + config.service_id
        headers = {'Content-Type': 'application/json'}
        data = {
    ...
    # def test_06_deleteservice_id(self):
    #     '''删除业务系统[delete] /api/service/:service_id'''
    #     url = config.base_url + "/api/service/5da448e026816f7971eca352"
    #     headers = {'Content-Type': 'application/json'}
    #
    #     r = requests.delete(url, headers=headers)
    #     jobs = r.json()
